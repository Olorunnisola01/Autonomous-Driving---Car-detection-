...
I walked to the door. I opened it. The wind howled outside, cold and sharp. The village was dark, the streets empty. The manor on the hill was a black shape against the grey sky. I stepped out into the cold. And I began to walk.""", "FINCH_BINDERY", 1),
...
I kept walking.""", "FINCH_BINDERY", 1),
...
I picked up my satchel and began to look for the east corridor.""", "WINTER_ROAD", 1),
...
I turned and walked quickly toward the east corridor, my boots loud on the stone floor. I didn't look back. I didn't want to see if he was watching me again. But I knew he was. I knew he would be watching me for a long time to come.""", "BLACKTHORN_GATES", 1),
...
Then she was gone, leaving me alone with the books and the dust and the silence. I opened my notebook and began.""", "BLACKTHORN_FOYER", 1),
...
And I didn't know what that meant.""", "BLACKTHORN_LIBRARY", 1),
...
And I didn't know whether to be terrified or flattered.""", "BLACKTHORN_LIBRARY", 1),
...
And I didn't know what she wanted.""", "BLACKTHORN_LIBRARY", 1),
...
I sat there for a long time, my hand touching the spot on my temple where his finger had grazed my skin. And I didn't know whether to be terrified or flattered. Perhaps both. Perhaps that was the point.""", "BLACKTHORN_GALLERY", 1),
...
So I stood there, with the contract between us and the fire at our backs, and I did neither.""", "BLACKTHORN_LIBRARY", 1),
...
And for the first time since I had entered this house, I did not know whether he was threatening me or promising me something. Perhaps both.""", "BLACKTHORN_STUDY", 1),
...
The Duke did not ask me to dance. He simply did not let go.""", "BLACKTHORN_DINING_HALL", 1),
...
The fire popped again. The candlelight guttered. And I sat in his chair with his secrets scattered on the desk between us, and I did not know whether to rise and leave or stay and be destroyed.""", "BLACKTHORN_BALLROOM", 1),
...
I felt like a woman who had come to be found.""", "BLACKTHORN_STUDY", 1),
...
And in that silence, in that refusal to speak, I understood the shape of the thing I had walked into. It was not a marriage. It was not a bargain. It was a possession that had begun before I was born, and I was only now, too late, learning its true name.""", "BLACKTHORN_LIBRARY", 1),
...
I ran through the kitchens, through the servants' door, into the cold, and I did not stop until the house was a shape of fire against the winter sky, and the portrait of Lady Margaret was ash, and I was finally, truly, alone.""", "BLACKTHORN_STUDY", 1),
...
Because there was nowhere else I wanted to be.""", "BLACKTHORN_GROUNDS", 1),
